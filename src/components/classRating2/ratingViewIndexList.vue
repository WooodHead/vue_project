  ...
  <div style="background-color: #fff;padding:10px;">
    <div v-for="item in dataSource.rows">
      <div class="weui_cell vux-tap-active"
           v-link="'/rating2/class/week?classId='+item.ClassId+'&className='+item.ClassName">
        ...
        <div class="weui_cell_ft with_arrow">
          {{item.RatingResultForAvg>0?item.RatingResultForAvg+'☆':''}}
        </div>
      </div>
    </div>
  </div>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        dataRanges: [{name: '今天', value: '7'}, {name: '昨天', value: '8'}, {name: '本周', value: '2'}, {
          name: '上周',
          value: '5'
        }, {name: '本月', value: '3'}, {name: '上月', value: '6'}, {name: '本学期', value: '1'}, {name: '上学期', value: '4'}],
        dateRangeType: ['2'],
        dataSource: {},
    ...
    methods: {
      loadData () {
        ...
        AppHelper.post(AppHelper.ApiUrls.rating2_GetClassSata, cfg).then(function (jsonData) {
